env <- read.csv("env_low.csv",header = T, row.names = 1)
library(vegan)
library(ggplot2)
library(ggrepel)


Algae <- read.csv('algae_TX_low.csv',header = T,row.names = 1)
Cyanobacteria <- read.csv('cyanobacteria_TX_low.csv',header = T,row.names = 1)
Rotifer <- read.csv('rotifer_TX_low.csv',header = T,row.names = 1)
Cladocera <- read.csv('cladocera_TX_low.csv',header = T,row.names = 1)
Copepod <- read.csv('copepod_TX_low.csv',header = T,row.names = 1)
...
TX_low_class <- read.csv('class_TX_low.csv',header = T,row.names = 1)
TX_low.table <- TX_low_class
...
for(group in groupes.names){
  print(group)
  Mxp.plot.loc=Mxp.plot[TX_low.table[which(TX_low.table[,2]==group),1],]
...
write.csv(BICgraph.med,'TX_low_result.csv')
